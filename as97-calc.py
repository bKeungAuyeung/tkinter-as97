...
ax.semilogx(periods, Sa_rock_mean, color = "#980043", label="Mean Ground Motions", linestyle ="-")
# ax.semilogx(periods, Sa_rock_high, color = "#980043", label=", linestyle = ":")
# ax.semilogx(periods, Sa_rock_low, color = "#980043", label="PGA Estimate: -1σ", linestyle = ":")
ax.fill_between(periods, Sa_rock_low, Sa_rock_high, color = "#980043", alpha = 0.2, linestyle = ":", label="$$\pm 1\sigma$$")
